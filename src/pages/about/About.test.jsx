  ...
  return (
    <div
      className={`container-fluid h-full py-16 px-6 md:px-12 lg:px-24 xl:px-48 ${
        theme === 'light' ? 'bg-gray-200 text-gray-900' : 'bg-gray-900 text-gray-200'
      }`}
    >
      ...
      <h2 className="text-2xl font-extrabold mb-6 text-center uppercase tracking-wide">
        Our Mission
      </h2>
      ...
      <h2 className=" font-extrabold mb-6 text-center uppercase">
        Meet Our Team
      </h2>
        ...
        {teamMembers.map((member, index) => (
          ...
          >
            <Link to="/">
              ...
              />
              <h3 className="text-xl font-bold mb-1 tracking-wide text-center">
                {member.name}
              </h3>
